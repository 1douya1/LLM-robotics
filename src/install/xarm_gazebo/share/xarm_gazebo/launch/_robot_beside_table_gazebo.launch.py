...
def launch_setup(context, *args, **kwargs):
    ...
    #rviz with MTC configuration
    rviz_config_file = PathJoinSubstitution([FindPackageShare(moveit_config_package_name), 'rviz', 'Gazebo_MTC.rviz' if no_gui_ctrl.perform(context) == 'true' else 'moveit.rviz'])
